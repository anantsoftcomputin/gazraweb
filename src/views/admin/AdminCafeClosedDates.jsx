          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                <li>• Customers will not be able to book tables on the dates you mark as closed</li>
                <li>• When they select a closed date, they will see a warning message</li>
                <li>• Past dates are shown for reference but do not affect new bookings</li>
